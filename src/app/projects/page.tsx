...
export default function Projects() {
  ...
  const projects: Project[] = [
    {
      ...
      website: "https://hello-world-caa.vercel.app/",
    },
    {
      title: "Compleo",
      image: "/compleo.png",
    ...
    },
    {
      ...
      image: "/moosiecouture.webp",
      category: "landing pages",
      website: "https://moosie-couture.vercel.app/",
    },
    {
  ...
  return (
    <div className="flex items-center justify-center relative h-screen bg-swirl">
      ...
      <main
        data-aos="flip-up"
        className="w-[90%] lg:w-[60%] h-[90%] flex flex-col justify-start items-center p-8 bg-white border-2 border-black rounded-xl overflow-y-auto"
      >
        ...
        <div className="w-full grid grid-cols-2 lg:grid-cols-4 space-x-2 my-4">
          ...
          <Button
            onClick={() => setFilter("landing pages")}
            className={`px-4 py-2 border border-black rounded-lg ${
        ...
        <div className="flex flex-row justify-center space-x-2 mt-4 font-bold">
          ...
          <h3 className="text-black text-center text-xs md:text-sm">
            Made with React, Typescript, Tailwind CSS, Next JS
          </h3>
          <h2 className="text-xs md:text-sm animate-spin">*</h2>
        </div>
        <AlertDialog
